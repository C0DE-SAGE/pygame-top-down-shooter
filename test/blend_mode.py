...
class Star(pygame.sprite.Sprite):
	def __init__(self, pos):
		super().__init__()
		self.image = pygame.image.load('test\graphics\oie_transparent.png').convert_alpha()
...
while True:
	...
	emitter.update()
	emitter.render()
	# star_surf = pygame.Surface((500, 500), SRCALPHA)
	# star_surf.fill((0, 0, 0, 0))
	# star_surf.blit(star_image, (100, 100), special_flags=BLEND_RGBA_ADD)
	# star_surf.blit(star_image, (130, 100), special_flags=BLEND_RGBA_ADD)
